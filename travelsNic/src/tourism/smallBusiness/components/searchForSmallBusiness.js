...
import Separator from './../utilities/textDivider'

export  const SearchForSmallBusiness = (props) => {
                ...
                <View style={styles.modalContainer}>
                    ...
                    <View style={styles.center}>
                        <Text style = {styles.textDescriptiontitle}>
                            Filtro de Hoteles y Restaurantes
                        </Text>
                    </View>
...
export default SearchForSmallBusiness;
